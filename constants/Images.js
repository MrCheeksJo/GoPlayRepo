// local imgs
const Onboarding = require("../assets/imgs/Onboarding1.jpg");
const Logo = require("../assets/imgs/FinalLogoGPSmall.jpg");
const TEST = require("../assets/imgs/giphy123.gif");
...
const ProfilePicture = 'https://hmp.me/dg44';
